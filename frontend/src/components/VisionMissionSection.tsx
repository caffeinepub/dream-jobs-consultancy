          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl">
              ...
              <p className="text-white/90 leading-relaxed">
                To become a leading and trusted overseas recruitment partner, empowering individuals to build successful international careers while maintaining the highest standards of integrity and transparency.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl">
              ...
              <p className="text-white/90 leading-relaxed">
                To connect skilled professionals with verified global employers through a structured, ethical, and supportive recruitment process that prioritizes candidate welfare and long-term success.
              </p>
            </div>
          </div>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="w-14 h-14 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                  <value.icon className="h-7 w-7 text-blue-900" />
                </div>
